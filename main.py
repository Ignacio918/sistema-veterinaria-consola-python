...
def registrar_mascota():
    ...
    salud = input("Estado de la salud de la mascota: ")
    precio = float(input("Precio de la atención de la mascota: "))
...
def mostrar_menu():
    print("\n --- Menú para gestión de Peluditos --- ")
...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            print("Saliendo del sistema. ¡Gracias por usar Peludos System!")
            break
        else:
